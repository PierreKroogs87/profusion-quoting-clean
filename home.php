...
<head>
    ...
    <title>Home - Insurance App</title>
    ...
    <main>
        <div class="container mt-3">
            ...
            <div class="container mt-4">
                <h2 class="mb-4">Welcome to Profusion Insurance</h2>
                <div class="d-flex flex-column align-items-start">
                    <a href="quote_management/new_quote.php" class="btn btn-primary mb-3">Create a New Quote</a>
                    <a href="dashboard.php" class="btn btn-success mb-3">Search for Existing Quote</a>
                    <a href="client_services/client_services.php" class="btn btn-secondary mb-3">Client Services</a>
                    <?php if (strpos($_SESSION['role_name'], 'Profusion') === 0 || strpos($_SESSION['role_name'], 'Broker Admin') === 0) { ?>
                        <a href="user_management/manage_users.php" class="btn btn-warning mb-3">Maintain Users</a>
                    <?php } ?>
                    <a href="documents.php" class="btn btn-info mb-3">Important Documents</a>
                    <?php if (strpos($_SESSION['role_name'], 'Profusion') === 0 || strpos($_SESSION['role_name'], 'Manager') !== false) { ?>
                        <a href="reporting.php" class="btn btn-danger mb-3">Reporting</a>
                    <?php } ?>
                </div>
            </div>
